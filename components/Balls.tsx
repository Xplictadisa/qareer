...
export const BackgroundCircles = ({
  ...
  return (
    <div className='absolute -top-[42.375rem] hidden xl:block left-1/2 w-[78rem] aspect-square border border-n-2/5 rounded-full -translate-x-1/2 md:-top-[38.5rem] xl:-top-[32rem]'>
